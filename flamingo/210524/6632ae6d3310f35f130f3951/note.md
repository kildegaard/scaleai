...
In your case, the first prompt is very good. It has many of these mentioned items. It's good quality. The second prompt also is good. It's less complex, but that's expected for follow-up prompts. Yet, it has a good structure and also asks for new things. The problem comes with the third prompt: it's too easy and has no complexity at all. It should provide new things to the overall conversation. This is what you should improve when redoing this task.
