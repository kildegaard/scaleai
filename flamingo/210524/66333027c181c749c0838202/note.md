...
According to actual guidelines, your prompt have several issues to deal with, and your justification lack some compulsory elements for them to be excellent ones.
...
In your case, the prompt provided lacks context, constraints and some level of complexity. Moreover, it's really hard to set the correct environment to test it. As such, what can't be tested can't be approved either. Also, there are many specific details missing to make it clearer. For example, when you talk about the "installed travel app".
