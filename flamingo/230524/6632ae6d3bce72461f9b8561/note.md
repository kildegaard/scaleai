Dear contributor, your prompt does not align with the actual Guidelines. You are supposed to deliver prompts that are innovative, creative, and complex to the model. This is just a common high-school academic situation that does not provide a challenge to the LLM.

I will provide you with some suggestions to improve your prompts and justifications!
