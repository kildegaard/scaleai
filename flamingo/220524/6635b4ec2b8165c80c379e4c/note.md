...
According to actual guidelines, your prompt has several issues to deal with and your justifications lack some compulsory elements for them to be excellent ones.
...
In your case, your prompt generates code that's not easily testable without having the correct environment. You should provide prompts that are meant to be tested within reason.
