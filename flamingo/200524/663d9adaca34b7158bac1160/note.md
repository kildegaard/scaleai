...
I have a web app with multiple users, and I have the log of the routes they visit sequentially. I want to group users with similar behavior pattern together. I want to implement longest common substring and longest common subsequences to find similar people.

Group instances with longest common subsequence greater than 3 into a cluster

Help me plot the frequency of user belonging to clusters having longest common subsequence from 3 to 8.
...
In your case, the complex is not enough for this project's standards, they lack constraints, and context. Also, follow-up prompts are too easy: that don't add complexity nor uniqueness to the overall situation. 
